...
1. In your Unity project, create a folder at `Assets/Editor/` (if it doesn't already exist)
2. Download the `.cs` script from this repository
3. Place it inside `Assets/Editor/`
4. That's it — Unity will pick it up automatically as an Editor script

## Requirements

- Unity (any recent LTS version should work)
- Linux with [COSMIC DE](https://system76.com/cosmic)
